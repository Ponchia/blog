...
<OptimizedImage
  src="/optimized_image.png"
  alt="Comparison of optimized vs non-optimized images - JPEG file looking sad vs happy WebP file"
  width={800}
  height={800}
  format="png"
  loading="eager"
...
<Alert type="info">
  The illustration above shows the difference between traditional unoptimized JPEG images and modern
  WebP format. WebP files are typically 25-34% smaller with equivalent visual quality.
</Alert>
