...
# Display a message while packages are loading
display("Loading packages... This may take a moment.")

# Import necessary packages (micropip is already available)
import micropip

# Define and execute the async function for installing packages
async def setup():
    await micropip.install("matplotlib")
    await micropip.install("numpy")
    
    # Now that we have the packages, import them
    import matplotlib.pyplot as plt
    import numpy as np
    
    display("Packages loaded successfully! Creating visualizations...")
...
# Start the setup process and provide targets for the plots
display("<div id='bar-chart'></div>")
display("<div id='tri-chart'></div>")
