...
description: 'The story behind this blog, its architecture, features, and why I chose to make it open source'
pubDate: 'Mar 30 2025'
heroImage: 'blog-placeholder-1.jpg'
mocs: ['Getting Started', 'Behind the Scenes']
tags: ['astro', 'blogging', 'web development', 'open source']
status: 'evergreen'
...
<div style={{ height: '400px', marginBottom: '2rem', border: '1px solid var(--border-color)', borderRadius: '0.5rem' }}>
  <GraphView 
    client:only="react"
    graphData={{
      nodes: [
