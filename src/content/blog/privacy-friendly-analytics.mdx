...
<OptimizedImage
  src="/goat_analytics.png"
  alt="Goat mascot showing privacy-friendly analytics with no tracking - cartoon of a goat with a computer showing analytics without privacy concerns"
  width={800}
  height={600}
  format="png"
  loading="eager"
